...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'clockingAndIntsInit'
;------------------------------------------------------------
;	board.c:8: void clockingAndIntsInit(void)
;	-----------------------------------------
;	 function clockingAndIntsInit
;	-----------------------------------------
_clockingAndIntsInit:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
...
;	board.c:10: IEN0 = 0;
	mov	_IEN0,#0x00
;	board.c:11: CLKEN = 0x00;	 // timers only for now
	mov	_CLKEN,#0x00
;	board.c:12: CLKSPEED = 0x01; // fast crystal
	mov	_CLKSPEED,#0x01
;	board.c:13: }
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	board.c:15: void powerPortsDownForSleep(void)
;	-----------------------------------------
...
;	board.c:25: P2PULL = 0;
	mov	_P2PULL,#0x00
;	board.c:26: P0DIR = 0x80;
	mov	_P0DIR,#0x80
;	board.c:27: P1DIR = 0;
	mov	_P1DIR,#0x00
;	board.c:28: P2DIR = 0b11111001;
	mov	_P2DIR,#0xf9
;	board.c:31: P0LVLSEL = 0x00;
	mov	_P0LVLSEL,#0x00
;	board.c:32: P0CHSTA = 0x00;
	mov	_P0CHSTA,#0x00
;	board.c:33: P0INTEN = 0x80;
	mov	_P0INTEN,#0x80
;	board.c:34: }
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	board.c:36: void boardInit(void)
;	-----------------------------------------
;	 function boardInit
;	-----------------------------------------
_boardInit:
;	board.c:38: wdtOff();
	lcall	_wdtOff
;	board.c:40: P0FUNC = 0b10000111;// No UART TXD pim since we want to wake up later
	mov	_P0FUNC,#0x87
;	board.c:41: P1FUNC = 0b00000000;
	mov	_P1FUNC,#0x00
;	board.c:42: P2FUNC = 0b00000000;
	mov	_P2FUNC,#0x00
;	board.c:43: P0 = 0;
	mov	_P0,#0x00
;	board.c:44: P1 = 0;
...
;	board.c:45: P2 = 0;
	mov	_P2,#0x00
;	board.c:46: P0PULL = 0x00;
	mov	_P0PULL,#0x00
;	board.c:47: P1PULL = 0x00;
	mov	_P1PULL,#0x00
;	board.c:48: P2PULL = 0x00;
	mov	_P2PULL,#0x00
;	board.c:49: P0DIR = 0b01111100;
	mov	_P0DIR,#0x7c
;	board.c:50: P1DIR = 0b00111011;
	mov	_P1DIR,#0x3b
;	board.c:51: P2DIR = 0b11111001;
	mov	_P2DIR,#0xf9
;	board.c:54: P1_1 = 1;
;	assignBit
	setb	_P1_1
