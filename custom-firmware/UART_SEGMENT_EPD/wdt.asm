...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'wdtOff'
;------------------------------------------------------------
;cfgPageBck                Allocated with name '_wdtOff_cfgPageBck_65536_4'
;------------------------------------------------------------
;	wdt.c:5: void wdtOff(void)
;	-----------------------------------------
;	 function wdtOff
;	-----------------------------------------
_wdtOff:
	...
	ar1 = 0x01
	ar0 = 0x00
;	wdt.c:9: cfgPageBck = CFGPAGE;
	mov	dptr,#_wdtOff_cfgPageBck_65536_4
	mov	a,_CFGPAGE
	movx	@dptr,a
;	wdt.c:10: CFGPAGE = 4;
	mov	_CFGPAGE,#0x04
;	wdt.c:11: WDTENA = 0;
	mov	_WDTENA,#0x00
;	wdt.c:12: WDTCONF &=~ 0x80;
	anl	_WDTCONF,#0x7f
;	wdt.c:13: CFGPAGE = cfgPageBck;
	mov	dptr,#_wdtOff_cfgPageBck_65536_4
	movx	a,@dptr
	mov	_CFGPAGE,a
;	wdt.c:14: }
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'wdtDeviceReset'
;------------------------------------------------------------
;	wdt.c:16: void wdtDeviceReset(void)
;	-----------------------------------------
;	 function wdtDeviceReset
;	-----------------------------------------
_wdtDeviceReset:
;	wdt.c:18: CFGPAGE = 4;
	mov	_CFGPAGE,#0x04
;	wdt.c:19: WDTCONF = 0x80;
	mov	_WDTCONF,#0x80
;	wdt.c:20: WDTENA = 1;
	mov	_WDTENA,#0x01
;	wdt.c:21: WDTRSTVALH = 0xff;
	mov	_WDTRSTVALH,#0xff
;	wdt.c:22: WDTRSTVALM = 0xff;
	mov	_WDTRSTVALM,#0xff
;	wdt.c:23: WDTRSTVALL = 0xff;
	mov	_WDTRSTVALL,#0xff
;	wdt.c:24: while(1);
00102$:
;	wdt.c:25: }
	sjmp	00102$
